...
def get_model(model_name: str, model_provider: ModelProvider, api_keys: dict = None) -> ChatOpenAI | ChatGroq | ChatOllama | GigaChat | None:
    ...
    if model_provider == ModelProvider.GROQ:
        ...
        return ChatGroq(model=model_name, api_key=api_key, max_retries=2)
        ...
        return ChatAnthropic(model=model_name, api_key=api_key, max_retries=2)
        ...
        return ChatDeepSeek(model=model_name, api_key=api_key, max_retries=2)
        ...
        return ChatGoogleGenerativeAI(model=model_name, api_key=api_key, max_retries=2)
        ...
        return ChatXAI(model=model_name, api_key=api_key, max_retries=2)
        ...
        return AzureChatOpenAI(azure_endpoint=azure_endpoint, azure_deployment=azure_deployment_name, api_key=api_key, api_version="2024-10-21", max_retries=2)
    else:
        raise ValueError(
